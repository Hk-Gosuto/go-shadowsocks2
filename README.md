...
GoDoc at https://godoc.org/github.com/Hk-Gosuto/go-shadowsocks2/
...
Pre-built binaries are available from https://github.com/Hk-Gosuto/go-shadowsocks2/releases

You can also build from source:

```sh
go get -u -v github.com/Hk-Gosuto/go-shadowsocks2
```
